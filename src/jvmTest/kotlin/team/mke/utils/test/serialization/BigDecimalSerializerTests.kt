...
class BigDecimalSerializerTests : FreeSpec({
    ...
    "deserialization" {
        Json.decodeFromString(BigDecimalSerializer, "0".wrap('"')) shouldBe BigDecimal(0)
        Json.decodeFromString(BigDecimalSerializer, "0.1".wrap('"')) shouldBe BigDecimal.valueOf(0.1)
        Json.decodeFromString(BigDecimalSerializer, "0.12345678".wrap('"')) shouldBe BigDecimal.valueOf(0.12345678)
        Json.decodeFromString(BigDecimalSerializer, "0.123456781".wrap('"')) shouldBe BigDecimal.valueOf(0.123456781)
        Json.decodeFromString(BigDecimalSerializer, "0.123456789".wrap('"')) shouldBe BigDecimal.valueOf(0.123456789)
    }
})