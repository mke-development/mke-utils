...
val DevDelay = createRouteScopedPlugin("DevDelay") {
    onCall { call ->
        val delay = (call.request.headers[HttpHeaders.XDevDelay]
            ?: call.request.headers["dev-delay"])?.toLongOrNull()?.milliseconds
            ?: devDelay
...
val HttpHeaders.XDevDelay: String get() = "X-Dev-Delay"
